      ...
      <section className="mx-auto flex min-h-[calc(100vh-6rem)] max-w-[1160px] items-center justify-center">
        <div className="grid w-full max-w-[980px] gap-6 md:grid-cols-4">
          {cards.map((card, index) => (
            <article key={index} className="relative mx-auto flex aspect-[0.68] w-full max-w-[175px] flex-col overflow-hidden bg-white shadow-[0_14px_28px_rgba(0,0,0,0.08)]">
              <div className="relative h-[38%] px-4 pt-3" style={{ background: card.top }}>
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-[2rem] leading-none font-black tracking-[-0.12em]">9</span>
                </div>
              </div>
              <div className="flex-1 bg-[#f6f3ee]" />
              <div className="relative flex h-[27%] flex-col justify-end px-4 py-3" style={{ background: card.bottom }}>
              ...
              <div
                className="absolute left-5 top-[20%] h-[45%] w-[72%] shadow-[0_8px_14px_rgba(0,0,0,0.12)]"
