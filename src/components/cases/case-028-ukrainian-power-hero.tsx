...
export function Case028UkrainianPowerHero() {
  return (
    <main className="min-h-screen bg-[#f3f2ef] px-3 py-3 text-black sm:px-5 lg:px-8">
      <section className="mx-auto min-h-[calc(100vh-1.5rem)] max-w-[1240px] overflow-hidden rounded-[1.6rem] bg-[radial-gradient(circle_at_20%_10%,rgba(0,0,0,0.035),transparent_26%),radial-gradient(circle_at_75%_35%,rgba(0,0,0,0.04),transparent_22%),#f3f2ef] px-4 py-4 shadow-[0_24px_54px_rgba(0,0,0,0.12)] sm:px-6 sm:py-5">
        ...
        <div className="mt-8 grid gap-6 xl:grid-cols-[0.66fr_1.34fr] xl:items-start">
          <aside className="max-w-[16rem] text-[clamp(1.3rem,2.2vw,2rem)] leading-[0.88] font-semibold uppercase tracking-[-0.08em]">
            &amp;UP is a showcase
            <br />
          ...
          <div className="space-y-2 text-[clamp(2.4rem,5.7vw,6.3rem)] leading-[0.86] font-light uppercase tracking-[-0.085em]">
        ...
        <div className="mt-8 grid gap-3 lg:grid-cols-3">
          {metrics.map(([value, label], index) => (
            <article key={value} className="relative overflow-hidden rounded-[2.5rem] bg-black px-4 py-5 text-white sm:px-6 sm:py-6">
        ...
        <button className="mt-3 flex w-full items-center justify-center gap-5 rounded-[2rem] bg-[#18ff17] px-6 py-5 text-[clamp(1.55rem,2vw,2.1rem)] uppercase tracking-[-0.06em] text-black transition hover:brightness-95">
          <span>↗</span>
