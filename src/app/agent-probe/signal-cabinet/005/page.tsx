...
const sansFace = Archivo({
  subsets: ["latin"],
  variable: "--font-signal-cabinet-005-sans",
  weight: ["400", "500", "600", "700", "800"],
});

const serifFace = Cormorant_Garamond({
  subsets: ["latin"],
  variable: "--font-signal-cabinet-005-serif",
  weight: ["500", "600", "700"],
  style: ["normal", "italic"],
});
...
const navigation = ["Issue", "Archive", "Notes", "Letters"];

const issueBlocks: IssueBlock[] = [
  {
    number: "1",
    date: "19.03.2026",
    title: "Fragments before the filing system",
    excerpt:
      "Signal Cabinet opens with loose screenshots, field notes, and unfinished captions before they harden into categories.",
  },
  {
    number: "2",
    date: "19.03.2026",
    title: "Recurrence without dashboard logic",
    excerpt:
      "The assistant notices echoes and pairings across the archive, but keeps the surface publication-led rather than product-led.",
  },
];
...
export default function SignalCabinet005Page() {
  ...
  return (
    <main
      ...
      style={{ fontFamily: "var(--font-signal-cabinet-005-sans)" }}
    >
              ...
              <div className="grid grid-cols-1 gap-5 pt-4 lg:grid-cols-[minmax(14rem,1.04fr)_minmax(18rem,1fr)]">
                ...
                <div className="space-y-2.5">
                  <h2 className="max-w-[16ch] text-[clamp(1.75rem,2.5vw,2.45rem)] font-semibold leading-[0.94] tracking-[-0.065em] text-[#101010]">
                    Reading the <span style={{ fontFamily: "var(--font-signal-cabinet-005-serif)", fontStyle: "italic", fontWeight: 600 }}>scattered</span>
                    <br />
                    signals before they become categories
                  </h2>

                  <div className="flex flex-wrap items-center justify-between gap-3 text-[0.95rem] tracking-[-0.025em] text-[#161616]/76">
                    <p>
                      By <span className="font-medium text-[#111111]">Signal Cabinet Desk</span>
                    </p>
                    <p style={{ fontFamily: "var(--font-signal-cabinet-005-serif)", fontStyle: "italic" }}>5 Min Read</p>
                  </div>

                  <p className="max-w-[38ch] text-[0.99rem] leading-[1.4] tracking-[-0.02em] text-[#161616]/84">
                    A publication surface for fragments, screenshots, and field notes that should remain atmospheric a little longer before an assistant resolves them into a filing logic.
                  </p>
                </div>
              </div>
          ...
          <aside id="featured" className="flex flex-col py-6 lg:py-9 lg:pl-4 xl:pl-6">
            <div className="relative mb-9 h-6 overflow-hidden bg-[#121212]">
              <div className="absolute inset-y-0 right-0 flex items-center pr-2">
                <span className="signal-cabinet-dot h-2.5 w-2.5 rounded-full bg-[#ebe7e0]" />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between gap-4 border-b border-black/12 pb-3">
              <p
                ...
                style={{ fontFamily: "var(--font-signal-cabinet-005-serif)", fontStyle: "italic", fontWeight: 500 }}
              >
                Cabinet Notes
              </p>
              <a
      ...
      <style jsx>{`
        .signal-cabinet-dot {
          animation: signalCabinetPulse 4.6s cubic-bezier(0.45, 0, 0.25, 1) infinite;
        }

        @keyframes signalCabinetPulse {
          0%,
          100% {
